...
var React9, import_react15, isBrowser2, hasOwn, EmotionCacheContext, CacheProvider, withEmotionCache, ThemeContext, getTheme, createCacheWithTheme, typePropName, labelPropName, Insertion, Emotion;
var init_emotion_element_43c6fea0_browser_esm = __esm({
  "node_modules/@emotion/react/dist/emotion-element-43c6fea0.browser.esm.js"() {
    ...
    withEmotionCache = function withEmotionCache2(func) {
      return (0, import_react15.forwardRef)(function(props, ref) {
        var cache2 = (0, import_react15.useContext)(EmotionCacheContext);
...
var import_react17, tags, newStyled;
...
var React12, import_prop_types, import_jsx_runtime2, cache;
...
var React13, import_prop_types2, import_jsx_runtime3;
  ...
  "node_modules/@mui/system/createTheme/createBreakpoints.js"(exports) {
    ...
    function createBreakpoints2(breakpoints) {
      const {
        ...
        unit: unit2 = "px",
        step = 5
      } = breakpoints, other = (0, _objectWithoutPropertiesLoose2.default)(breakpoints, _excluded41);
...
var require_createTheme = __commonJS({
  "node_modules/@mui/system/createTheme/createTheme.js"(exports) {
    ...
    var _excluded41 = ["breakpoints", "palette", "spacing", "shape"];
    function createTheme3(options = {}, ...args) {
      const {
        ...
        spacing: spacingInput,
        shape: shapeInput = {}
      } = options, other = (0, _objectWithoutPropertiesLoose2.default)(options, _excluded41);
...
var require_extendSxProp = __commonJS({
  "node_modules/@mui/system/styleFunctionSx/extendSxProp.js"(exports) {
    ...
    function extendSxProp2(props) {
      const {
        sx: inSx
      } = props, other = (0, _objectWithoutPropertiesLoose2.default)(props, _excluded41);
      const {
        systemProps,
        otherProps
      } = splitProps2(other);
...
var require_createStyled = __commonJS({
  "node_modules/@mui/system/createStyled.js"(exports) {
    ...
    function processStyleArg2(callableStyle, _ref) {
      let {
        ownerState
      } = _ref, props = (0, _objectWithoutPropertiesLoose2.default)(_ref, _excluded41);
...
function useCurrentColorScheme(options) {
  ...
  const setMode = React35.useCallback((mode2) => {
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider2(props) {
    ...
    const ctx2 = React36.useContext(ColorSchemeContext);
    ...
    const element = (0, import_jsx_runtime11.jsxs)(React36.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime11.jsxs)(React36.Fragment, {
...
function createContainer(options = {}) {
  ...
  const Container2 = React37.forwardRef(function Container3(inProps, ref) {
...
function SeriesContextProvider(props) {
  ...
  const formattedSeries = React42.useMemo(() => ({
    isInitialized: true,
...
function useSeries() {
  const {
    isInitialized,
    data
  } = React43.useContext(SeriesContext);
  if (!isInitialized) {
...
function useBarSeries() {
  ...
  return React43.useMemo(() => series.bar, [series.bar]);
}
...
function CartesianContextProvider(props) {
  ...
  const xAxis = React44.useMemo(() => inXAxis == null ? void 0 : inXAxis.map((axisConfig) => {
  ...
  const yAxis = React44.useMemo(() => inYAxis == null ? void 0 : inYAxis.map((axisConfig) => {
    const dataKey = axisConfig.dataKey;
    if (dataKey === void 0 || axisConfig.data !== void 0) {
      return axisConfig;
    }
...
var InteractionContext = React48.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React48.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React48.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
var _excluded19 = ["highlighted", "faded"];
var mergeDeprecatedOptions = (options) => {
  const _ref = options ?? {}, {
    highlighted,
    faded
  } = _ref, rest = _objectWithoutPropertiesLoose(_ref, _excluded19);
  return _extends({
...
function HighlightedProvider({
  ...
  return (0, import_jsx_runtime20.jsx)(HighlightedContext.Provider, {
    value: providerValue,
    children
  });
}
...
var ZAxisContext = React52.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React52.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
    const dataKey = axisConfig.dataKey;
    if (dataKey === void 0 || axisConfig.data !== void 0) {
      return axisConfig;
    }
  ...
  return (0, import_jsx_runtime21.jsx)(ZAxisContext.Provider, {
    value,
    children
  });
}
...
function BarElement(props) {
  ...
  return (0, import_jsx_runtime22.jsx)(Bar, _extends({}, barProps));
}
...
function useChartId() {
  ...
  return React55.useMemo(() => chartId, [chartId]);
}
...
function BarClipRect(props) {
  ...
  return (0, import_jsx_runtime23.jsx)(animated.rect, {
...
function BarClipPath(props) {
  ...
  return (0, import_jsx_runtime23.jsx)("clipPath", {
    id: maskId,
    children: (0, import_jsx_runtime23.jsx)(BarClipRect, {
      ownerState: rest,
      style: style4
    })
  });
...
function BarLabel(props) {
  ...
  return (0, import_jsx_runtime24.jsx)(BarLabelComponent, _extends({}, otherProps));
}
...
function BarLabelItem(props) {
  ...
  return (0, import_jsx_runtime25.jsx)(Component, _extends({}, barLabelProps, barLabelOwnerState, {
...
function BarLabelPlot(props) {
  ...
  return (0, import_jsx_runtime26.jsx)(React61.Fragment, {
    children: barLabelTransition((style4, {
      ...
      width: width2,
      height: height2
    }) => (0, import_jsx_runtime26.jsx)(BarLabelItem, _extends({
      seriesId,
      dataIndex,
      value,
      color: color3,
...
true ? BarLabelPlot.propTypes = {
  ...
  bars: import_prop_types26.default.arrayOf(import_prop_types26.default.shape({
    ...
    maskId: import_prop_types26.default.string.isRequired,
    ...
    xOrigin: import_prop_types26.default.number.isRequired,
    y: import_prop_types26.default.number.isRequired,
    yOrigin: import_prop_types26.default.number.isRequired
  })).isRequired,
...
function BarPlot(props) {
  ...
  return (0, import_jsx_runtime27.jsxs)(React62.Fragment, {
    children: [maskTransition((style4, {
      ...
      return (0, import_jsx_runtime27.jsx)(BarClipPath, {
        maskId: id,
        borderRadius: borderRadius2,
        hasNegative,
        hasPositive,
      ...
      const barElement = (0, import_jsx_runtime27.jsx)(BarElement, _extends({
        id: seriesId,
        dataIndex,
        color: color3
      }, other, {
      ...
      return (0, import_jsx_runtime27.jsx)("g", {
        clipPath: `url(#${maskId})`,
        children: barElement
      });
    }), barLabel && (0, import_jsx_runtime27.jsx)(BarLabelPlot, _extends({
      bars: completedData,
      skipAnimation: skipAnimation2,
      barLabel
    }, other))]
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime29.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime29.jsxs)(React65.Fragment, {
        children: [(0, import_jsx_runtime29.jsx)("stop", {
          offset: offset2,
          stopColor: colorMap.colors[index2],
          stopOpacity: 1
        }), (0, import_jsx_runtime29.jsx)("stop", {
          offset: offset2,
...
function useChartGradient() {
  ...
  return React67.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime31.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "piecewise") {
        return (0, import_jsx_runtime31.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse2,
          scale,
          colorMap,
          size: svgHeight,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime31.jsx)(ChartsContinuousGradient, {
          isReversed: !reverse2,
          scale,
          colorScale,
          colorMap,
    ...
    children: (0, import_jsx_runtime32.jsx)(SeriesContextProvider, {
      ...
      children: (0, import_jsx_runtime32.jsx)(CartesianContextProvider, {
        ...
        children: (0, import_jsx_runtime32.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime32.jsx)(HighlightedProvider, {
            highlightedItem,
            onHighlightChange,
            children: (0, import_jsx_runtime32.jsxs)(ChartsSurface, {
              width: width2,
              height: height2,
              ref: handleRef,
              sx,
              ...
              desc,
              disableAxisListener,
              children: [(0, import_jsx_runtime32.jsx)(ChartsAxesGradients, {}), children]
            })
          })
        })
      })
...
var useChartContainerDimensions = (inWidth, inHeight) => {
  ...
  const [width2, setWidth] = React70.useState(0);
  const [height2, setHeight] = React70.useState(0);
...
var ResponsiveChartContainer = React71.forwardRef(function ResponsiveChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime33.jsx)(ResizableContainer, {
    ...
    children: width2 && height2 ? (0, import_jsx_runtime33.jsx)(ChartContainer, _extends({}, other, {
      width: width2,
      height: height2,
      ref
    })) : null
...
function ChartsText(props) {
  ...
  const wordsByLines = React72.useMemo(() => getWordsByLines({
    style: style4,
  ...
  return (0, import_jsx_runtime34.jsx)("text", _extends({}, textProps, {
    x: x2,
    y: y2,
    textAnchor,
    dominantBaseline,
    style: style4,
    children: wordsByLines.map((line2, index2) => (0, import_jsx_runtime34.jsx)("tspan", {
      x: x2,
...
true ? ChartsText.propTypes = {
   ...
   */
  lineHeight: import_prop_types31.default.number,
  /**
   * If `true`, the line width is computed.
   * @default false
   */
  needsComputation: import_prop_types31.default.bool,
  ownerState: import_prop_types31.default.any,
  /**
   ...
   * Text displayed.
   */
  text: import_prop_types31.default.string.isRequired
} : void 0;
...
function ChartsXAxis(inProps) {
  ...
  const _xAxis = xAxis[inProps.axisId ?? xAxisIds[0]], {
    ...
    tickNumber,
    reverse: reverse2
  } = _xAxis, settings = _objectWithoutPropertiesLoose(_xAxis, _excluded33);
  ...
  return (0, import_jsx_runtime35.jsxs)(AxisRoot, {
    transform: `translate(0, ${position3 === "bottom" ? top3 + height2 : top3})`,
    className: classes.root,
    children: [!disableLine && (0, import_jsx_runtime35.jsx)(Line, _extends({
      x1: xScale.range()[0],
      x2: xScale.range()[1],
      ...
      return (0, import_jsx_runtime35.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime35.jsx)(Tick, _extends({
          y2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && (0, import_jsx_runtime35.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
    ...
    }), label && (0, import_jsx_runtime35.jsx)("g", {
      className: classes.label,
      children: (0, import_jsx_runtime35.jsx)(Label, _extends({}, labelRefPoint, axisLabelProps, {
        text: label
      }))
    })]
  });
...
function ChartsYAxis(inProps) {
  const {
    yAxisIds,
    yAxis
  } = React75.useContext(CartesianContext);
  const _yAxis = yAxis[inProps.axisId ?? yAxisIds[0]], {
    scale: yScale,
    tickNumber
  } = _yAxis, settings = _objectWithoutPropertiesLoose(_yAxis, _excluded34);
  const themedProps = useThemeProps2({
    props: _extends({}, settings, inProps),
    name: "MuiChartsYAxis"
  });
...
true ? ChartsYAxis.propTypes = {
   ...
   * Position of the axis.
   */
  position: import_prop_types33.default.oneOf(["left", "right"]),
  /**
   * The props used for each component slot.
   * @default {}
   */
...
function ChartsAxis(props) {
  ...
  const {
    ...
    yAxis,
    yAxisIds
  } = React76.useContext(CartesianContext);
  ...
  return (0, import_jsx_runtime37.jsxs)(React76.Fragment, {
    children: [topId && (0, import_jsx_runtime37.jsx)(ChartsXAxis, _extends({}, topAxisProps, {
      position: "top",
      axisId: topId
    })), bottomId && (0, import_jsx_runtime37.jsx)(ChartsXAxis, _extends({}, bottomAxisProps, {
      position: "bottom",
      axisId: bottomId
    })), leftId && (0, import_jsx_runtime37.jsx)(ChartsYAxis, _extends({}, leftAxisProps, {
      position: "left",
      axisId: leftId
    })), rightId && (0, import_jsx_runtime37.jsx)(ChartsYAxis, _extends({}, rightAxisProps, {
      position: "right",
      axisId: rightId
    }))]
  });
...
true ? ChartsAxis.propTypes = {
   ...
   */
  bottomAxis: import_prop_types34.default.oneOfType([import_prop_types34.default.object, import_prop_types34.default.string]),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types34.default.oneOfType([import_prop_types34.default.object, import_prop_types34.default.string]),
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
   */
  rightAxis: import_prop_types34.default.oneOfType([import_prop_types34.default.object, import_prop_types34.default.string]),
  /**
   * The props used for each component slot.
   * @default {}
   */
   ...
   * @default null
   */
  topAxis: import_prop_types34.default.oneOfType([import_prop_types34.default.object, import_prop_types34.default.string])
} : void 0;
...
var Portal = React77.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  } = props;
  const [mountNode, setMountNode] = React77.useState(null);
  const handleRef = useForkRef(React77.isValidElement(children) ? children.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React77.isValidElement(children)) {
      ...
      return React77.cloneElement(children, newProps);
    }
    return (0, import_jsx_runtime38.jsx)(React77.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime38.jsx)(React77.Fragment, {
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime40.jsx)(React79.Fragment, {
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React80.useState(null);
  React80.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function ChartsItemTooltipContent(props) {
  ...
  const {
    ...
    xAxisIds,
    yAxisIds
  } = React82.useContext(CartesianContext);
  const {
    zAxis,
    zAxisIds
  } = React82.useContext(ZAxisContext);
  const defaultXAxisId = xAxisIds[0];
  const defaultYAxisId = yAxisIds[0];
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types39.default.shape({
    classes: import_prop_types39.default.object,
    getColor: import_prop_types39.default.func,
    ...
    series: import_prop_types39.default.object,
...
var Typography = React83.forwardRef(function Typography2(inProps, ref) {
  const themeProps = useThemeProps2({
    props: inProps,
    name: "MuiTypography"
  });
      ...
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime44.jsx)("thead", {
        ...
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime44.jsxs)(ChartsTooltipRow, {
            ...
            children: [(0, import_jsx_runtime44.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: (0, import_jsx_runtime44.jsx)(ChartsTooltipMark, {
...
function ChartsAxisTooltipContent(props) {
  ...
  const {
    zAxisIds,
    zAxis
  } = React85.useContext(ZAxisContext);
  const series = useSeries();
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React85.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React85.useMemo(() => {
...
function ChartsTooltip(props) {
  ...
  return (0, import_jsx_runtime46.jsx)(NoSsr, {
...
function DefaultChartsLegend(props) {
  ...
  const labelStyle = React87.useMemo(
  ...
  const padding2 = React87.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React87.useCallback((label, inStyle = {}) => {
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React87.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
  ...
  return (0, import_jsx_runtime47.jsx)(NoSsr, {
    children: (0, import_jsx_runtime47.jsx)(ChartsLegendRoot, {
      className: classes.root,
...
function ChartsLegend(inProps) {
  ...
  return (0, import_jsx_runtime48.jsx)(ChartLegendRender, _extends({}, chartLegendRenderProps));
}
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime49.jsxs)(React89.Fragment, {
    children: [xAxisHighlight === "band" && axis.x !== null && isBandScale(xScale) && (0, import_jsx_runtime49.jsx)(ChartsAxisHighlightPath, {
    ...
    }), yAxisHighlight === "band" && axis.y !== null && isBandScale(yScale) && (0, import_jsx_runtime49.jsx)(ChartsAxisHighlightPath, {
...
var _excluded38 = ["vertical", "horizontal"];
...
function ChartsGrid(props) {
  ...
  const {
    ...
    yAxis,
    yAxisIds
  } = React91.useContext(CartesianContext);
  const classes = useUtilityClasses11(themeProps);
  ...
  return (0, import_jsx_runtime51.jsxs)(GridRoot, _extends({}, other, {
    className: classes.root,
...
function ChartsOnAxisClickHandler(props) {
  ...
  return (0, import_jsx_runtime52.jsx)(React92.Fragment, {});
}
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime53.jsx)(StyledText, _extends({
    x: left3 + width2 / 2,
    y: top3 + height2 / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime54.jsx)(StyledText2, _extends({
    x: left3 + width2 / 2,
    y: top3 + height2 / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime55.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime55.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}
...
var BarChart = React96.forwardRef(function BarChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime56.jsxs)(ResponsiveChartContainer, {
    ...
    highlightedItem,
    onHighlightChange,
    children: [onAxisClick && (0, import_jsx_runtime56.jsx)(ChartsOnAxisClickHandler, {
      onAxisClick
    }), grid2 && (0, import_jsx_runtime56.jsx)(ChartsGrid, {
      vertical: grid2.vertical,
      horizontal: grid2.horizontal
    }), (0, import_jsx_runtime56.jsxs)("g", {
      clipPath: `url(#${clipPathId})`,
      children: [(0, import_jsx_runtime56.jsx)(BarPlot, {
        slots,
        slotProps,
        skipAnimation: skipAnimation2,
        onItemClick,
        borderRadius: borderRadius2,
        barLabel
      }), (0, import_jsx_runtime56.jsx)(ChartsOverlay, {
        loading,
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime56.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      ...
      slots,
      slotProps
    })), (0, import_jsx_runtime56.jsx)(ChartsAxisHighlight, _extends({}, defaultizedAxisHighlight)), !loading && (0, import_jsx_runtime56.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), (0, import_jsx_runtime56.jsx)(ChartsClipPath, {
      id: clipPathId
    }), children]
  });
});
