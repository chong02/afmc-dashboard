...
function useSeries() {
  const {
    isInitialized,
    data
  } = React9.useContext(SeriesContext);
  if (!isInitialized) {
...
function useBarSeries() {
  ...
  return React9.useMemo(() => series.bar, [series.bar]);
}
...
var InteractionContext = React14.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React14.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React14.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
var _excluded4 = ["highlighted", "faded"];
var mergeDeprecatedOptions = (options) => {
  const _ref = options ?? {}, {
    highlighted,
    faded
  } = _ref, rest = _objectWithoutPropertiesLoose(_ref, _excluded4);
  return _extends({
...
function ZAxisContextProvider(props) {
  ...
  return (0, import_jsx_runtime8.jsx)(ZAxisContext.Provider, {
    value,
    children
  });
}
...
var _excluded5 = ["id", "dataIndex", "classes", "color", "slots", "slotProps", "style", "onClick"];
...
function BarElement(props) {
  ...
  return (0, import_jsx_runtime9.jsx)(Bar, _extends({}, barProps));
}
...
function BarClipRect(props) {
  ...
  return (0, import_jsx_runtime10.jsx)(animated.rect, {
...
function BarClipPath(props) {
  ...
  return (0, import_jsx_runtime10.jsx)("clipPath", {
    id: maskId,
    children: (0, import_jsx_runtime10.jsx)(BarClipRect, {
      ownerState: rest,
      style
    })
  });
...
var _excluded7 = ["seriesId", "dataIndex", "color", "isFaded", "isHighlighted", "classes"];
...
function BarLabel(props) {
  ...
  const otherProps = _objectWithoutPropertiesLoose(themeProps, _excluded7);
  return (0, import_jsx_runtime11.jsx)(BarLabelComponent, _extends({}, otherProps));
}
...
var _excluded8 = ["seriesId", "classes", "color", "style", "dataIndex", "barLabel", "slots", "slotProps", "height", "width", "value"];
...
function BarLabelItem(props) {
  ...
  return (0, import_jsx_runtime12.jsx)(Component, _extends({}, barLabelProps, barLabelOwnerState, {
...
var _excluded9 = ["bars", "skipAnimation"];
var leaveStyle = ({
  layout,
  yOrigin,
  x: x2,
...
function BarLabelPlot(props) {
  ...
  return (0, import_jsx_runtime13.jsx)(React28.Fragment, {
    children: barLabelTransition((style, {
      ...
      width,
      height
    }) => (0, import_jsx_runtime13.jsx)(BarLabelItem, _extends({
      seriesId,
      dataIndex,
      value,
      color: color2,
...
var _excluded10 = ["skipAnimation", "onItemClick", "borderRadius", "barLabel"];
...
var useAggregatedData = () => {
  ...
  const axisData = React29.useContext(CartesianContext);
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React30.useRef({
    x: -1,
    y: -1
  });
  React30.useEffect(() => {
...
var ChartsSurface = React31.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime16.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime16.jsxs)(React32.Fragment, {
...
var ChartContainer = React36.forwardRef(function ChartContainer2(props, ref) {
  ...
  useReducedMotion2();
  return (0, import_jsx_runtime19.jsx)(DrawingProvider, {
    width,
    height,
    margin,
    svgRef,
    children: (0, import_jsx_runtime19.jsx)(SeriesContextProvider, {
      series,
      colors: colors3,
      dataset,
      seriesFormatters,
      children: (0, import_jsx_runtime19.jsx)(CartesianContextProvider, {
        xAxis,
        yAxis,
        dataset,
        children: (0, import_jsx_runtime19.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime19.jsx)(HighlightedProvider, {
            highlightedItem,
            onHighlightChange,
            children: (0, import_jsx_runtime19.jsxs)(ChartsSurface, {
              width,
              height,
              ref: handleRef,
              sx,
              ...
              desc,
              disableAxisListener,
              children: [(0, import_jsx_runtime19.jsx)(ChartsAxesGradients, {}), children]
            })
          })
        })
      })
...
var ResponsiveChartContainer = React38.forwardRef(function ResponsiveChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime20.jsx)(ResizableContainer, {
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    },
    children: width && height ? (0, import_jsx_runtime20.jsx)(ChartContainer, _extends({}, other, {
      width,
      height,
      ref
    })) : null
...
var Portal = React44.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React44.isValidElement(children) ? children.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
function DefaultChartsItemTooltipContent(props) {
  ...
  return (0, import_jsx_runtime28.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.root,
    children: (0, import_jsx_runtime28.jsx)(ChartsTooltipTable, {
      className: classes.table,
      children: (0, import_jsx_runtime28.jsx)("tbody", {
        children: (0, import_jsx_runtime28.jsxs)(ChartsTooltipRow, {
          ...
          children: [(0, import_jsx_runtime28.jsx)(ChartsTooltipCell, {
            ...
            children: (0, import_jsx_runtime28.jsx)(ChartsTooltipMark, {
              color: color2,
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types20.default.shape({
    classes: import_prop_types20.default.object,
    getColor: import_prop_types20.default.func,
    itemData: import_prop_types20.default.shape({
      ...
      type: import_prop_types20.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired
    }),
    series: import_prop_types20.default.object,
...
true ? ChartsAxisTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types23.default.shape({
    axis: import_prop_types23.default.object,
    axisData: import_prop_types23.default.shape({
      x: import_prop_types23.default.shape({
        index: import_prop_types23.default.number,
        value: import_prop_types23.default.oneOfType([import_prop_types23.default.instanceOf(Date), import_prop_types23.default.number, import_prop_types23.default.string]).isRequired
...
function DefaultChartsLegend(props) {
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React54.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime36.jsxs)(React56.Fragment, {
    children: [xAxisHighlight === "band" && axis.x !== null && isBandScale(xScale) && (0, import_jsx_runtime36.jsx)(ChartsAxisHighlightPath, {
    ...
    }), yAxisHighlight === "band" && axis.y !== null && isBandScale(yScale) && (0, import_jsx_runtime36.jsx)(ChartsAxisHighlightPath, {
...
true ? ChartsClipPath.propTypes = {
  ...
  offset: import_prop_types28.default.shape({
...
function ChartsOnAxisClickHandler(props) {
  ...
  return (0, import_jsx_runtime39.jsx)(React59.Fragment, {});
}
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime40.jsx)(StyledText, _extends({
    x: left2 + width / 2,
    y: top2 + height / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime41.jsx)(StyledText2, _extends({
    x: left2 + width / 2,
    y: top2 + height / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime42.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime42.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}
...
var BarChart = React63.forwardRef(function BarChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime43.jsxs)(ResponsiveChartContainer, {
    ref,
    ...
    highlightedItem,
    onHighlightChange,
    children: [onAxisClick && (0, import_jsx_runtime43.jsx)(ChartsOnAxisClickHandler, {
      onAxisClick
    }), grid && (0, import_jsx_runtime43.jsx)(ChartsGrid, {
      vertical: grid.vertical,
      horizontal: grid.horizontal
    }), (0, import_jsx_runtime43.jsxs)("g", {
      clipPath: `url(#${clipPathId})`,
      children: [(0, import_jsx_runtime43.jsx)(BarPlot, {
        slots,
        slotProps,
        skipAnimation: skipAnimation2,
        onItemClick,
        borderRadius,
        barLabel
      }), (0, import_jsx_runtime43.jsx)(ChartsOverlay, {
        loading,
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime43.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime43.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime43.jsx)(ChartsAxisHighlight, _extends({}, defaultizedAxisHighlight)), !loading && (0, import_jsx_runtime43.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), (0, import_jsx_runtime43.jsx)(ChartsClipPath, {
      id: clipPathId
    }), children]
  });
});
